...
@Component({
  selector: 'app-store-food-coach',
  templateUrl: './store-food-coach.component.html',
  styleUrls: ['./store-food-coach.component.scss'],
})
export class StoreFoodCoachComponent  implements OnInit {
  ...
  /**
   * Same code as for the food-program page
   * @param productId 
   */
